...
struct Opentelemetry_Proto_Collector_Logs_V1_ExportLogsServiceResponse {
    ...
    var hasPartialSuccess: Bool { self._partialSuccess != nil }
    /// Clears the value of `partialSuccess`. Subsequent reads from it will return its default value.
    mutating func clearPartialSuccess() { _partialSuccess = nil }

    var unknownFields = SwiftProtobuf.UnknownStorage()

    init() {}

    private var _partialSuccess: Opentelemetry_Proto_Collector_Logs_V1_ExportLogsPartialSuccess?
}
...
private let _protobuf_package = "opentelemetry.proto.collector.logs.v1"
...
extension Opentelemetry_Proto_Collector_Logs_V1_ExportLogsPartialSuccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if rejectedLogRecords != 0 {
            try visitor.visitSingularInt64Field(value: rejectedLogRecords, fieldNumber: 1)
        }
