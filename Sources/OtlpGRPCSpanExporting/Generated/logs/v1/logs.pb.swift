...
struct Opentelemetry_Proto_Logs_V1_LogRecord {
    ...
    mutating func clearBody() { _body = nil }
    ...
    private var _body: Opentelemetry_Proto_Common_V1_AnyValue?
}
...
extension Opentelemetry_Proto_Logs_V1_LogsData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !resourceLogs.isEmpty {
            try visitor.visitRepeatedMessageField(value: resourceLogs, fieldNumber: 1)
        }
...
extension Opentelemetry_Proto_Logs_V1_ResourceLogs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !scopeLogs.isEmpty {
            try visitor.visitRepeatedMessageField(value: scopeLogs, fieldNumber: 2)
        }
...
extension Opentelemetry_Proto_Logs_V1_ScopeLogs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !logRecords.isEmpty {
            try visitor.visitRepeatedMessageField(value: logRecords, fieldNumber: 2)
        }
        if !schemaURL.isEmpty {
            try visitor.visitSingularStringField(value: schemaURL, fieldNumber: 3)
        }
...
extension Opentelemetry_Proto_Logs_V1_LogRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if severityNumber != .unspecified {
            try visitor.visitSingularEnumField(value: severityNumber, fieldNumber: 2)
        }
        if !severityText.isEmpty {
            try visitor.visitSingularStringField(value: severityText, fieldNumber: 3)
        }
        try { if let v = self._body {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
        } }()
        if !attributes.isEmpty {
            try visitor.visitRepeatedMessageField(value: attributes, fieldNumber: 6)
        }
        if droppedAttributesCount != 0 {
            try visitor.visitSingularUInt32Field(value: droppedAttributesCount, fieldNumber: 7)
        }
        if flags != 0 {
            try visitor.visitSingularFixed32Field(value: flags, fieldNumber: 8)
        }
        if !traceID.isEmpty {
            try visitor.visitSingularBytesField(value: traceID, fieldNumber: 9)
        }
        if !spanID.isEmpty {
            try visitor.visitSingularBytesField(value: spanID, fieldNumber: 10)
        }
        if observedTimeUnixNano != 0 {
            try visitor.visitSingularFixed64Field(value: observedTimeUnixNano, fieldNumber: 11)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
