...
private let _protobuf_package = "opentelemetry.proto.resource.v1"
...
extension Opentelemetry_Proto_Resource_V1_Resource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !attributes.isEmpty {
            try visitor.visitRepeatedMessageField(value: attributes, fieldNumber: 1)
        }
        if droppedAttributesCount != 0 {
            try visitor.visitSingularUInt32Field(value: droppedAttributesCount, fieldNumber: 2)
        }
