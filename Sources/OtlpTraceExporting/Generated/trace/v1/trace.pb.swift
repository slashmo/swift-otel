...
struct Opentelemetry_Proto_Trace_V1_Span {
    ...
    var traceID: Data {
        get { return self._storage._traceID }
    ...
    /// This field is required.
    var spanID: Data {
        get { return self._storage._spanID }
    ...
    var traceState: String {
        get { return self._storage._traceState }
    ...
    var parentSpanID: Data {
        get { return self._storage._parentSpanID }
    ...
    /// This field is required.
    var name: String {
        get { return self._storage._name }
    ...
    var kind: Opentelemetry_Proto_Trace_V1_Span.SpanKind {
        get { return self._storage._kind }
    ...
    var startTimeUnixNano: UInt64 {
        get { return self._storage._startTimeUnixNano }
    ...
    var endTimeUnixNano: UInt64 {
        get { return self._storage._endTimeUnixNano }
    ...
    var attributes: [Opentelemetry_Proto_Common_V1_KeyValue] {
        get { return self._storage._attributes }
    ...
    var droppedEventsCount: UInt32 {
        get { return self._storage._droppedEventsCount }
    ...
    var links: [Opentelemetry_Proto_Trace_V1_Span.Link] {
        get { return self._storage._links }
    ...
    var droppedLinksCount: UInt32 {
        get { return self._storage._droppedLinksCount }
    ...
    var status: Opentelemetry_Proto_Trace_V1_Status {
        get { return self._storage._status ?? Opentelemetry_Proto_Trace_V1_Status() }
...
extension Opentelemetry_Proto_Trace_V1_Span: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    fileprivate class _StorageClass {
        ...
        init(copying source: _StorageClass) {
            self._traceID = source._traceID
            self._spanID = source._spanID
            self._traceState = source._traceState
            self._parentSpanID = source._parentSpanID
            self._name = source._name
            self._kind = source._kind
            self._startTimeUnixNano = source._startTimeUnixNano
            self._endTimeUnixNano = source._endTimeUnixNano
            self._attributes = source._attributes
            self._droppedAttributesCount = source._droppedAttributesCount
            self._events = source._events
            self._droppedEventsCount = source._droppedEventsCount
            self._links = source._links
            self._droppedLinksCount = source._droppedLinksCount
